...
func ToAddress(_address string) string {
	return "0x" + _address[26:]
}
...
func ToAmount(_value string) string {
	
	amount := TrimLeadingZero(_value)
	return amount[2:]
}
